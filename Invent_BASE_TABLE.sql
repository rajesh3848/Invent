...
CREATE TABLE `BASE_User` (
	...
	`Name`	VARCHAR	(40) NOT NULL,
	`PasswordEncrypted`	VARCHAR	(40) NOT NULL,
	`IsAdministrator`	INT	(2) NOT NULL,
	`Timestamp`	TIMESTAMP,	
	`IsActive`	INT	(2) NOT NULL,
	`LocationId`	INT	(4),
	`SalesPersonID`	VARCHAR	(40)
)


CREATE TABLE `Base_UserRights` (
	`UserId`	INT	(4) NOT NULL,
	`RightsCode`	INT	(4) NOT NULL
)


CREATE TABLE `BASE_Vendor` (
	`VendorId`	INT	(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
	`Name`	VARCHAR	(40) NOT NULL,
	`Remarks`	VARCHAR	(40),
	`DefaultPaymentTermsId`	INT	(4),
	`DefaultOrderTaxCodeId`	INT	(4),
	`DefaultCarrier` VARCHAR	(40),
	`Address1`	VARCHAR	(40),
	`Address2`	VARCHAR	(40),
	`City`	VARCHAR	(40),
	`State`	VARCHAR	(40),
...
CREATE TABLE `BASE_VendorAddress` (
	`VendorAddressId`	INT	(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `BASE_VendorBalance` (
	`VendorId`	INT	(4) NOT NULL,
...
CREATE TABLE `BASE_VendorBalanceTotal` (
	`VendorId`	INT	(4) NOT NULL,
	`Balance`	DECIMAL	(20,2),
	`Timestamp`	TIMESTAMP
)
...
CREATE TABLE `BASE_VendorItem` (
	`VendorItemId`	INT	(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
	`VendorId`	INT	(4)  NOT NULL,
